...
#			elif (__has_builtin(__builtin_rintl))
				return mu0_fp128(__builtin_rintl(mu0_const_fpex(x)));
#			else
				return mu0_fp128(rintl(mu0_const_fpex(x)));
#			endif
#		else
...
#			elif (__has_builtin(__builtin_rintf))
				return mu0_fp16(__builtin_rintf(mu0_const_fp32(x)));
#			else
				return mu0_fp16(rintf(mu0_const_fp32(x)));
#			endif
#		else
#			if (__has_builtin(__builtin_rintf))
				return __builtin_rintf(x);
