...
#			elif (__has_builtin(__builtin_acosl))
				return mu0_fp128(__builtin_acosl(mu0_const_fpex(x)));
#			else
				return mu0_fp128(acosl(mu0_const_fpex(x)));
#			endif
#		else
...
#			elif (__has_builtin(__builtin_acosf))
				return mu0_fp16(__builtin_acosf(mu0_const_fp32(x)));
#			else
				return mu0_fp16(acosf(mu0_const_fp32(x)));
#			endif
#		else
#			if (__has_builtin(__builtin_acosf))
				return __builtin_acosf(x);
