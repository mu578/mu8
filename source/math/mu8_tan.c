...
#			elif (__has_builtin(__builtin_tanl))
				return mu0_fp128(__builtin_tanl(mu0_const_fpex(x)));
#			else
				return mu0_fp128(tanl(mu0_const_fpex(x)));
#			endif
#		else
...
#			elif (__has_builtin(__builtin_tanf))
				return mu0_fp16(__builtin_tanf(mu0_const_fp32(x)));
#			else
				return mu0_fp16(tanf(mu0_const_fp32(x)));
#			endif
#		else
#			if (__has_builtin(__builtin_tanf))
				return __builtin_tanf(x);
