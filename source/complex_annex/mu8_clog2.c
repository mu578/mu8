...
#	if MU0_HAVE_STDCOMPLEX
	return mu8_clog_fp128 (z) / mu8_clog_fp128 (mu0_cfp128 (mu0_fp128_two, mu0_fp128_zero));
#	else
	mu0_cfp128_t c = { 0 };
...
{
#	if MU0_HAVE_STDCOMPLEX
	return mu8_clog_fp64  (z) / mu8_clog_fp64  (mu0_cfp64  (mu0_fp64_two, mu0_fp64_zero));
#	else
	mu0_cfp64_t  c = { 0 };
...
{
#	if MU0_HAVE_STDCOMPLEX
	return mu8_clog_fp32  (z) / mu8_clog_fp32  (mu0_cfp32  (mu0_fp32_two, mu0_fp32_zero));
#	else
	mu0_cfp32_t  c = { 0 };
