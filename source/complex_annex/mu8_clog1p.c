...
#	if MU0_HAVE_STDCOMPLEX
	mu0_cfp128_t c = { 0 };
	mu8_zlog1p_fp128 (&c.u_re, &c.u_im, mu8_creal_fp128(z), mu8_cimag_fp128(z));
	return mu0_cfp128(c.u_re, c.u_im);
#	else
	mu0_cfp128_t c = { 0 };
...
#	if MU0_HAVE_STDCOMPLEX
	mu0_cfp64_t  c = { 0 };
	mu8_zlog1p_fp64  (&c.u_re, &c.u_im, mu8_creal_fp64(z), mu8_cimag_fp64(z));
	return mu0_cfp64 (c.u_re, c.u_im);
#	else
	mu0_cfp64_t  c = { 0 };
...
#	if MU0_HAVE_STDCOMPLEX
	mu0_cfp32_t  c = { 0 };
	mu8_zlog1p_fp32  (&c.u_re, &c.u_im, mu8_creal_fp32(z), mu8_cimag_fp32(z));
	return mu0_cfp32 (c.u_re, c.u_im);
#	else
	mu0_cfp32_t  c = { 0 };
...
#	if MU0_HAVE_STDCOMPLEX
	mu0_cfp16_t  c = { 0 };
	mu8_zlog1p_fp16  (&c.u_re, &c.u_im, mu8_creal_fp16(z), mu8_cimag_fp16(z));
	return mu0_cfp16 (c.u_re, c.u_im);
#	else
	mu0_cfp16_t  c = { 0 };
