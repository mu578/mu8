...
#	else
	mu0_cfp128_t c = { 0 };
	mu8_zmul_fp128 (&c.u_re, &c.u_im, a.u_re, a.u_im, b.u_re, b.u_im);
	return c;
#	endif
}
...
#	else
	mu0_cfpex_t  c = { 0 };
	mu8_zmul_fpex  (&c.u_re, &c.u_im, a.u_re, a.u_im, b.u_re, b.u_im);
	return c;
#	endif
}
...
#	else
	mu0_cfp64_t  c = { 0 };
	mu8_zmul_fp64  (&c.u_re, &c.u_im, a.u_re, a.u_im, b.u_re, b.u_im);
	return c;
#	endif
}
...
#	else
	mu0_cfp32_t  c = { 0 };
	mu8_zmul_fp32  (&c.u_re, &c.u_im, a.u_re, a.u_im, b.u_re, b.u_im);
	return c;
#	endif
}
...
#	else
	mu0_fp16_t  cr, ci;
	mu8_zmul_fp16  (&cr, &ci, mu8_creal_fp16(a), mu8_cimag_fp16(a), mu8_creal_fp16(b), mu8_cimag_fp16(b));
	return mu0_cfp16(cr, ci);
#	endif
#	else
	mu0_cfp16_t  c = { 0 };
	mu8_zmul_fp16  (&c.u_re, &c.u_im, a.u_re, a.u_im, b.u_re, b.u_im);
	return c;
#	endif
}
