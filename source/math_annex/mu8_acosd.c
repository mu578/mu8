...
{
	return mu8_acos_fp128(x) / mu8_math_pio180_fp128;
}

mu0_fp64_t  mu8_acosd_fp64  (const mu0_fp64_t  x)
{
	return mu8_acos_fp64(x) / mu8_math_pio180_fp64;
}

mu0_fp32_t  mu8_acosd_fp32  (const mu0_fp32_t  x)
{
	return mu8_acos_fp32(x) / mu8_math_pio180_fp32;
}

mu0_fp16_t  mu8_acosd_fp16  (const mu0_fp16_t  x)
{
	return mu8_acos_fp16(x) / mu8_math_pio180_fp16;
}
