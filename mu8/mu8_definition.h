...
#	define MU8_HAVE_CC_GNUC 0
#	if defined(__GNUC__)
#	if __GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ > 8)
#		undef  MU8_HAVE_CC_GNUC
#		define MU8_HAVE_CC_GNUC 1
#	endif
#	endif

#	define MU8_HAVE_CC_CLANG 0
#	if defined(__clang__)
#	if defined(__is_identifier)
#		undef  MU8_HAVE_CC_CLANG
#		define MU8_HAVE_CC_CLANG 1
#	endif
#	endif

#	define MU8_HAVE_C89   1
#	define MU8_HAVE_C90   0
#	define MU8_HAVE_C94   0
#	define MU8_HAVE_C99   0
#	define MU8_HAVE_C11   0
#	define MU8_HAVE_C17   0

#	define MU8_HAVE_CPP98 0
#	define MU8_HAVE_CPP03 0
#	define MU8_HAVE_CPP11 0
#	define MU8_HAVE_CPP14 0
#	define MU8_HAVE_CPP17 0
#	define MU8_HAVE_CPP20 0

#	ifdef __cplusplus
#		undef  MU8_HAVE_CPP98
#		define MU8_HAVE_CPP98 1
#		if __cplusplus >= 199711L
#			undef  MU8_HAVE_CPP03
#			define MU8_HAVE_CPP03 1
#		endif
#		if __cplusplus >= 201103L
#			undef  MU8_HAVE_CPP11
#			define MU8_HAVE_CPP11 1
#		endif
#		if __cplusplus >= 201402L
#			undef  MU8_HAVE_CPP14
#			define MU8_HAVE_CPP14 1
#		endif
#		if __cplusplus >= 201703L
#			undef  MU8_HAVE_CPP17
#			define MU8_HAVE_CPP17 1
#		endif
#		if __cplusplus > 201703L
#			undef  MU8_HAVE_CPP20
#			define MU8_HAVE_CPP20 1
#		endif
#	endif
...
#			undef  MU8_HAVE_C90
#			define MU8_HAVE_C90 1
#			if (__STDC_VERSION__ >= 199409L)
#				undef  MU8_HAVE_C94
#				define MU8_HAVE_C94 1
#			endif
#			if (__STDC_VERSION__ >= 199901L)
#				undef  MU8_HAVE_C99
#				define MU8_HAVE_C99 1
#			endif
#			if (__STDC_VERSION__ >= 201112L)
#				undef  MU8_HAVE_C11
#				define MU8_HAVE_C11 1
#			endif
#			if (__STDC_VERSION__ >= 201710L)
#				undef  MU8_HAVE_C17
#				define MU8_HAVE_C17 1
#			endif
#		endif
#	endif

#	if !MU8_HAVE_C11 && !MU8_HAVE_CPP11
#	if !defined(_MSC_VER)
...
#	define mu8_cast(_Tp, __x)       (_Tp)(__x)
#	define mu8_const_cast(_Tp, __x) (const _Tp)(__x)
